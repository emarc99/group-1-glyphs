...
impl GlyphGenerator {
    ...
    pub fn metadata(&self) -> String {
        ...
        let metadata = format!(
            r#"{{"name":"Glyphs","description":"A Glyph generated by Stylus","image":"data:image/svg+xml;base64,{}"}}"#,
            base64_svg
        );
    ...
    fn generate_parameters(&self) -> GlyphParameters {
...
mod tests {
    ...
    fn test_svg_generation() {
        ...
        let config = GlyphGenerator::new(seed);
        let svg = config.svg();
